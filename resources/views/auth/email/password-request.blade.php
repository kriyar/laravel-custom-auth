    ...
    <table border="0" cellpadding="0" cellspacing="0" width="480" >
      <tr>
        <td bgcolor="#ffffff" align="center" valign="top" style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 4px; line-height: 48px;">
          <h1 style="font-size: 32px; font-weight: 400; margin: 0;">{{ __('Trouble signing in?') }}</h1>
        </td>
      </tr>
    </table>
  </td>
      ...
      <tr>
        <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;" >
          <p style="margin-top: 10px; margin-bottom: 20px;">
            ...
            Hello,
            @endif</p>
            <p style="margin: 0;">{{ __('We received a request to reset password. Please use the following code to verify your request within 15 minutes before reseting password') }}:
              <span style="font-size: 20px; font-weight: bold;">{{ $info->code }} </span>
              <br /><br />
              {{ __('You can click the button :verify to input verification code, then reset new password for your account.', ['verify' => "Verify now!"]) }}
            </p>
          </td>
        </tr>
        <!-- BULLETPROOF BUTTON -->
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="480" >
        ...
        <tr>
          <td bgcolor="#006df0" align="left" style="padding: 0px 30px 40px 30px; border-radius: 0px 0px 4px 4px; color: #ffffff; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;" >
            <p style="margin: 0;"><a href="{{ route('reset.pass.verify', ['token' => $info->verify_token]) }}" target="_blank" style="color: #ffffff;">{{ route('reset.pass.verify', ['token' => $info->verify_token]) }}</a></p>
          </td>
        </tr>
      </table>
    </td>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="480" >
        ...
        <tr>
          <td bgcolor="#f4f4f4" align="left" style="padding: 0px 30px 30px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 18px;" >
            <p style="margin: 0;">{{ __('You received this email because you requested a password reset. If you did not, ignore this email and the link will expire on its own.') }}</p>
          </td>
        </tr>
      </table>
    </td>
